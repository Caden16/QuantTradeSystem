"""
Django settings for quantTradeSystem project.
...
SECRET_KEY = 'n)w^i-aqemo#wk*-i&pgqen^1$(5ouyk@#4q9891=4sy_y)ey0'
...
WSGI_APPLICATION = 'quantTradeSystem.wsgi.application'
